...
function ensureSchema(db) {
  ...
  // L'unicita' nuova sta in due indici parziali, per la stessa ragione gia'
  // incontrata su clip/concorrenti: in SQLite due NULL sono distinti dentro un
  // UNIQUE, quindi UNIQUE(user_id, nome, file_origine) non impedirebbe due
  // righe omonime nel gruppo senza provenienza, che e' proprio dove non c'e'
  // un PDF a distinguerle. Gli indici si creano DOPO l'eventuale
  // ricostruzione: il DROP TABLE porta via quelli della tabella vecchia.
  db.exec(`
